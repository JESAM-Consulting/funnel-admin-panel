...
// });
import "./JaninaElargouiui.scss";
import InfoIcon from "@material-ui/icons/Info";

const JaninaElargouiui = () => {
  ...
  const getNewsData = async () => {
    ...
    await ApiGet(
      `qualified_contact?project=Janina.elargouiui&page=${page}&limit=${countPerPage}`
    )
      .then((res) => {
        ...
        <div className="p-2 mb-2">
          <div className="row mb-4 pr-3">
            <div className="col d-flex justify-content-between">
              <h2 className="pl-3 pt-2">Janina Elargouiui</h2>
            </div>
            <div className="col">
              <div>
                <input
...
export default JaninaElargouiui;

...
// });
import "./HouseFamilyLife.scss";
import InfoIcon from "@material-ui/icons/Info";

const HouseFamilyLife = () => {
  ...
  const getNewsData = async () => {
    ...
    await ApiGet(
      `qualified_contact?project=house-family-life&page=${page}&limit=${countPerPage}`
    )
      .then((res) => {
        ...
        <div className="p-2 mb-2">
          <div className="row mb-4 pr-3">
            <div className="col d-flex justify-content-between">
              <h2 className="pl-3 pt-2">House.Family.Life</h2>
            </div>
            <div className="col">
              <div>
                <input
...
export default HouseFamilyLife;
